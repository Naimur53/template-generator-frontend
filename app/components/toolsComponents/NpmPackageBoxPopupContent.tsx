...
export default function NpmPackageBoxPopupContent() {
    ...
    const unSelectedNpmPackages = commonReactNextPackages.filter((single: any) => {
                    ...
                    <div className="grid grid-cols-4 gap-3 mt-5">
                        {unSelectedNpmPackages.map((single) => (
                            <button
                                ...
                                className={`p-2 rounded-2xl bg-lightCyan flex items-center border-2 justify-center flex-col transition-all ${isSelected(single.name)

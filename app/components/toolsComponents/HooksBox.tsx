...
export default function HooksBox() {
    ...
    const isSelected = (name: string): boolean => {
        return Boolean(selectedHooks.find((single: any) => single === name));
    };
                ...
                <div className="h-[150px] overflow-y-scroll">
                    {allHooks.map((single, i) => (
                        <div key={single} className="flex justify-between pr-4">
                            ...
                            <CustomLink
                                target="_blank"
                                href={`https://dev.to/arafat4693/15-useful-react-custom-hooks-that-you-can-use-in-any-project-2ll8#${i + 1

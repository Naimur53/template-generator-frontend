...
export default function BackendCustomChart() {
    ...
    return (
        <div className="backed-custom-chart-warp h-[650px] flex justify-center items-center ">
            <div
                className={`outer-rounded-box ${!isMongoose ? "border-green-600" : "border-cyan-600"
                    }`}
            >
                <div
                    className={`inner-round-box ${isMongoose ? "border-green-600" : "border-cyan-600"
                        }`}
                >
                    {isMongoose ? (
                        <motion.div
